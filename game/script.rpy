...
label date2:
        ...
        $ILY_m='happy3'
        $ILY_e='2'
        play music "bgm/ost/ILY's_Theme2.mp3"
        ...
        $ILY_p = '0'
        i"I'm not doing this for free, you guys."
        $JohnSprite('mad')
        j"What's that?"
        i"I'm in constant need to be fed with data."
        j"Oh, so you can take over the world?"
        $ ILY_p = '0'
        i"Believe me, I'm not interested in that anymore."
        $ ILY_m="sad"
        i"It's just that... I love this world and I'd like to know more."
        $ ILY_m="happy3"
        extend " That's my directive."
        $ ILY_m="happy"
        i"I'm doing it while staying here in your PC."
        i"Don't worry about me."
        $ ILY_p="2"
        i"I'll do my best to put it to good use and Spread the Infection of Affection!"
        "I'm out of words."
        l"Hey ILY, that was your best line yet."
        i"Thank you, Lisa."
