...
#         (225,300),
#         (0,0),"images/Cards/Cardblank.png",
#         (11,14),"images/Cards/[card2name].png",
#         (11,219),Text("{color=#FFFF00}{font=font/adventpro-bold.ttf}{size=20}[card2name]{/color}{/font}{/size}"),
#         (17,240),Text("{size=18}[card2c.fxn]();{/size}"),
...
#         (225,300),
#         (0,0),"images/Cards/Cardblank.png",
#         (11,14),"images/Cards/[card3name].png",
#         (11,219),Text("{color=#FFFF00}{font=font/adventpro-bold.ttf}{size=20}[card3name]{/color}{/font}{/size}"),
#         (17,240),Text("{size=18}[card3c.fxn]();{/size}"),
#         (57,268),Text("{color=#ae81f2}{font=font/adventpro-bold.ttf}{size=20}[card3c.POW]{/color}{/font}{/size}"),
#         (132,268),Text("{color=#ae81f2}{font=font/adventpro-bold.ttf}{size=20}[card3c.SPD]{/color}{/font}{/size}"),
#         (169,260),Text("{color=#FFF}{font=font/adventpro-bold.ttf}{size=12}RANK {/color}{color=#FFFF00}[card3c.rank]{/color}{/font}{/size}")
#         )
#     # zoom 0.5
...
#         (225,300),
#         (0,0),"images/Cards/Cardblank.png",
#         (11,14),"images/Cards/[card4name].png",
#         (11,219),Text("{color=#FFFF00}{font=font/adventpro-bold.ttf}{size=20}[card4name]{/color}{/font}{/size}"),
#         (17,240),Text("{size=18}[card4c.fxn]();{/size}"),
#         (57,268),Text("{color=#ae81f2}{font=font/adventpro-bold.ttf}{size=20}[card4c.POW]{/color}{/font}{/size}"),
#         (132,268),Text("{color=#ae81f2}{font=font/adventpro-bold.ttf}{size=20}[card4c.SPD]{/color}{/font}{/size}"),
#         (169,260),Text("{color=#FFF}{font=font/adventpro-bold.ttf}{size=12}RANK {/color}{color=#FFFF00}[card4c.rank]{/color}{/font}{/size}")
#         )
#     # zoom 0.5
image Enemy:
